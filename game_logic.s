...
check_y_max
        ;cmp r4, #MAX_Y
        ble r4, #MAX_Y, check_x_collision ;branch if less or equal to 
...
check_x_collision
        ...
        cmp r1, #0      ;checks left
        bne check_right_wall ; branch if not equal
        ...
        blt r4, r5, miss_left           ;branch if ball_y < paddle1_y
        ...
        ;adjust yv based on the postion
        sub r7, r4, r5 ;r7 = hit postion (1 or 0)
        ldr r0, =ball_vy
        cmp r7, #0
        moveq r1, #-1 ; check if -1 works w/ compiler
        movne r1, #1
        str r1, [r0]
